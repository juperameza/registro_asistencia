...
class AsistenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asistencium" do
    assert_difference("Asistencium.count") do
      post asistencia_url, params: { asistencium: { alumno_id: @asistencium.alumno_id, asistencia: @asistencium.asistencia } }
    end
  ...
  test "should update asistencium" do
    patch asistencium_url(@asistencium), params: { asistencium: { alumno_id: @asistencium.alumno_id, asistencia: @asistencium.asistencia } }
