...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference("Alumno.count") do
      post alumnos_url, params: { alumno: { apellido_materno: @alumno.apellido_materno, apellido_paterno: @alumno.apellido_paterno, grado: @alumno.grado, grupo: @alumno.grupo, nombre: @alumno.nombre, numero_cuenta: @alumno.numero_cuenta } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { apellido_materno: @alumno.apellido_materno, apellido_paterno: @alumno.apellido_paterno, grado: @alumno.grado, grupo: @alumno.grupo, nombre: @alumno.nombre, numero_cuenta: @alumno.numero_cuenta } }
